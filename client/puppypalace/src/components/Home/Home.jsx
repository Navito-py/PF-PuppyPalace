    ...
    <div className="blue-backg">
      <nav className="navbar">
        ...
        <div className="navbar-links">
          <ul>
            <a href="http://localhost:3000/home">Pagina principal</a>
            <a href="http://localhost:3000/home/profile">Perfil</a>
            {/* <li><a href="http://localhost:3000/register">Nuevo Usuario</a></li>
            <li><a href="http://localhost:3000/login">Login</a></li>
          */}
            <a href="http://localhost:3000/emergencies">Emergencias</a>
          </ul>
        </div>
      </nav>
